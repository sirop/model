...
# Generated by qmake (2.01a) (Qt 4.8.0) on: Mon Jun 18 19:00:23 2012
# Project:  model.pro
# Template: app
# Command: /home/boris/QtSDK/Desktop/Qt/4.8.0/gcc/bin/qmake -o Makefile model.pro
#############################################################################
...
INCPATH       = -I../../../../QtSDK/Desktop/Qt/4.8.0/gcc/mkspecs/default -I. -I../../../../QtSDK/Desktop/Qt/4.8.0/gcc/include/QtCore -I../../../../QtSDK/Desktop/Qt/4.8.0/gcc/include/QtGui -I../../../../QtSDK/Desktop/Qt/4.8.0/gcc/include/QtXml -I../../../../QtSDK/Desktop/Qt/4.8.0/gcc/include -I. -I../../../HEADER -I../../../src/lib -I../../../src/lib/geodata/parser -I../../../src/lib/geodata/data -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/boris/QtSDK/Desktop/Qt/4.8.0/gcc/lib
LIBS          = $(SUBLIBS)  -L/home/boris/QtSDK/Desktop/Qt/4.8.0/gcc/lib /home/boris/marble-build/src/lib/libmarblewidget.so -lQtXml -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /home/boris/QtSDK/Desktop/Qt/4.8.0/gcc/bin/qmake
TAR           = tar -cf
COMPRESS      = gzip -9f
COPY          = cp -f
SED           = sed
...
Makefile: model.pro  ../../../../QtSDK/Desktop/Qt/4.8.0/gcc/mkspecs/default/qmake.conf ../../../../QtSDK/Desktop/Qt/4.8.0/gcc/mkspecs/common/unix.conf \
		../../../../QtSDK/Desktop/Qt/4.8.0/gcc/mkspecs/common/linux.conf \
		../../../../QtSDK/Desktop/Qt/4.8.0/gcc/mkspecs/common/gcc-base.conf \
		../../../../QtSDK/Desktop/Qt/4.8.0/gcc/mkspecs/common/gcc-base-unix.conf \
		../../../../QtSDK/Desktop/Qt/4.8.0/gcc/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/model1.0.0/ && $(COPY_FILE) --parents ImportKml.h MyMarbleWidget.h .tmp/model1.0.0/ && $(COPY_FILE) --parents ImportKml.cpp MyMarbleWidget.cpp main.cpp .tmp/model1.0.0/ && (cd `dirname .tmp/model1.0.0` && $(TAR) model1.0.0.tar model1.0.0 && $(COMPRESS) model1.0.0.tar) && $(MOVE) `dirname .tmp/model1.0.0`/model1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/model1.0.0
...
ImportKml.o: ImportKml.cpp ImportKml.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ImportKml.o ImportKml.cpp

MyMarbleWidget.o: MyMarbleWidget.cpp MyMarbleWidget.h \
		ImportKml.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyMarbleWidget.o MyMarbleWidget.cpp

main.o: main.cpp ImportKml.h
